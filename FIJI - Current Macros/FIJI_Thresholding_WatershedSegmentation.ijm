...
numchannels = 1; //use the number of 16-bit channels, if RGB set to 3
...
Ch1threslow = 0.15; // lower threshold for this channel, this is a "percentage" of the maximum signal from normalization, which helps intuitively. ie 0.20 means that what is kept is all values 20% or higher
Ch1MedianRadius = 2; //
